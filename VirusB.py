...
Security
Insights
ToxicBomber/Tbomb.py
@Toxic-Noob
Toxic-Noob Update Tbomb.py
 1 contributor
270 lines (221 sloc)  7.97 KB
# VirusBomber
...
def update():
    ...
    os.system("cd .. && rm -rf ToxicBomber && git clone https://github.com/Virus5522/VirusBomber > /dev/null 2>&1")
    
    psb("\n\033[92m    [\033[37m*\033[92m] Update Complete!")
    psb("\033[92m    [\033[37m*\033[92m] Starting Tool...")
    time.sleep(0.8)
    
    os.system("cd .. && cd VirusBomber && python VirusB.py")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : Virus5522                    \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/Virus5522 \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : Virus             \033[37mV3.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
